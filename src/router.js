...
export const units = [
  {
    ...
    demos: [
      { path: 'unit02-counter', title: 'vue-counter-2.vue', file: `${d1}/unit02-mental-model/vue-counter-2.vue`, component: VueCounter2, source: VueCounter2Source },
    ],
  },
  {
    title: 'Unit 03 – Template Syntax',
    demos: [
      { path: 'unit03-v-bind-wrong',  title: 'demo1-v-bind-wrong.vue',     file: `${d1}/unit03-template-syntax/demo1-v-bind-wrong.vue`,     component: Demo1VBindWrong, source: Demo1VBindWrongSource },
      { path: 'unit03-v-bind',        title: 'demo1-v-bind.vue',            file: `${d1}/unit03-template-syntax/demo1-v-bind.vue`,            component: Demo1VBind, source: Demo1VBindSource },
      { path: 'unit03-v-if',          title: 'demo2-v-if.vue',              file: `${d1}/unit03-template-syntax/demo2-v-if.vue`,              component: Demo2VIf, source: Demo2VIfSource },
      { path: 'unit03-v-show',        title: 'demo2-v-show.vue',            file: `${d1}/unit03-template-syntax/demo2-v-show.vue`,            component: Demo2VShow, source: Demo2VShowSource },
      { path: 'unit03-v-for-no-key',  title: 'demo3-v-for-without-key.vue', file: `${d1}/unit03-template-syntax/demo3-v-for-without-key.vue`, component: Demo3VForWithoutKey, source: Demo3VForWithoutKeySource },
      { path: 'unit03-v-for',         title: 'demo3-v-for.vue',             file: `${d1}/unit03-template-syntax/demo3-v-for.vue`,             component: Demo3VFor, source: Demo3VForSource },
    ],
  },
  {
    title: 'Unit 04 – v-model',
    demos: [
      { path: 'unit04-v-model',           title: 'demo-v-model.vue',           file: `${d1}/unit04-v-model/demo-v-model.vue`,           component: DemoVModel, source: DemoVModelSource },
      { path: 'unit04-v-model-explained', title: 'demo-v-model-explained.vue', file: `${d1}/unit04-v-model/demo-v-model-explained.vue`, component: DemoVModelExplained, source: DemoVModelExplainedSource },
      { path: 'unit04-v-model-keyup',     title: 'demo-v-model-keyup.vue',     file: `${d1}/unit04-v-model/demo-v-model-keyup.vue`,     component: DemoVModelKeyup, source: DemoVModelKeyupSource },
    ],
  },
  {
    title: 'Unit 06 – Computed',
    demos: [
      { path: 'unit06-computed', title: 'demo-computed-vs-method.vue', file: `${d1}/unit06-computed/demo-computed-vs-method.vue`, component: DemoComputedVsMethod, source: DemoComputedVsMethodSource },
    ],
  },
  {
    title: 'Unit 08 – onMounted & Watch',
    demos: [
      { path: 'unit08-watch',       title: 'demo-watch.vue',       file: `${d1}/unit08-onMounted-watch/demo-watch.vue`,       component: DemoWatch, source: DemoWatchSource },
      { path: 'unit08-watcheffect', title: 'demo-watchEffect.vue', file: `${d1}/unit08-onMounted-watch/demo-watchEffect.vue`, component: DemoWatchEffect, source: DemoWatchEffectSource },
    ],
  },
]
